...
pb = make_hotspot_map(cross_data$B$trans$combined_peaks,title = "YJM145 x YPS163 (B)")
p3004 = make_hotspot_map(cross_data$`3004`$trans$combined_peaks,title = "CBS2888 x YJM981 (C)")
